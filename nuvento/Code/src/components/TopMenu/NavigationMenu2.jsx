      ...
      <MDBContainer>
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className='ml-auto' navbar>
            ...
            <NavItem>
              <NavLink aria-label="navigate to Pledge page" activeClassName='active' tag={RRNavLink} to='/PledgesWithSearch' >Demo Data</NavLink>
            </NavItem>
            <NavItem>
              <NavLink aria-label="navigate to Pledge page" activeClassName='active' tag={RRNavLink} to='/Stepper' >Stepper Form</NavLink>
            </NavItem>
            {/* <NavItem>
