...
class StepTwo extends React.Component {
  ...
  componentDidMount() {
    ...
    localStorage.removeItem("loginFirstStep");
            ...
            <div class="register_first">
              ...
              <MDBContainer>
                <MDBRow>
                  ...
                  <form id="registrationSection2" className="stepperForm" noValidate autoComplete="off">
                      <TextField id="outlined-name" label="Username" className={'TextFieldWrapper'}
                        // helperText="Username already in use."
                        value={this.state.name} onChange={this.handleChangeNew('Username')} margin="normal" variant="filled" 
                        inputProps={{
                          ...
                          validatemessage: "Please enter Username",
                          mandatory: '1',
                          maxlength: "100",
                      }}
                        />
                      ...
                      <div className="passwordStrengthGroup">
                        <TextField id="filled-confirm-password" className={'TextFieldWrapper'} variant="filled" type={this.state.showConfirmPassword ? 'text' : 'password'}
                          ...
                          inputProps={{
                            invaliderrormessage: "Please enter Confirm Password",
                            'aria-label': "Please enter Confirm Password",
