    ...
    this.state = {
      ...
      render() {
        ...
        return (
          ...
          <div className="mixedChart mixedChartRes" id="chart">
            <ReactApexChart options={this.state.options} series={this.state.series} type="bar" height="350" className="mixedChartResCon"
            />
          </div>
          </MDBContainer>		  
        );
